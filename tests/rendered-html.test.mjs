...
test("connects the lesson shell to a functional learning map", async () => {
  ...
  assert.match(createPath, /generated\.mode === "live" \? "Generated by GPT-5\.6 Sol" : "Demo fallback"/);
  assert.match(workspace, /lesson\.mode === "live" \? "Generated by GPT-5\.6 Sol" : "Demo fallback"/);
